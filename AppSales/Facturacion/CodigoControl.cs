...
namespace AppSales.Facturacion
{
    public class CodigoControl
    {
        ...
        #region Singleton
        private static CodigoControl _instancia;
        private static int _version = CodigoControl.Version7;
        public static CodigoControl Instancia
        {
            get
            {
                if (_instancia == null)
                    _instancia = new CodigoControl();
